...
class SocietyDatabase{
    ...
    public:
        ...
        static void setStaff(string id, string name, float salary, string category, string designation){
        ...
        static void setGuard(string id, string name, float salary, string category, string shift, string location){
